...
namespace DepManager.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProjectID,ProjectName,ManagerID")] Project project)
        {
            ...
            ViewBag.ManagerID = new SelectList(db.Managers, "ManagerID", "FullName", project.ManagerID);
            return View(project);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProjectID,ProjectName,ManagerID")] Project project)
        {
            if (ModelState.IsValid)
            {
